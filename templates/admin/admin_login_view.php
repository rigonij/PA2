    ...
    <div class="sh-card p-4">
        ...
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <div>
                ...
                <div class="text-secondary small">Connexion à votre espace administrateur</div>
            </div>
        </div>
        ...
        <form method="POST" action="admin_login.php" class="d-grid gap-3">
        ...
        <p class="text-center text-secondary mb-0">
            Pas de compte admin?
            <a href="../public/admin_register.php" class="fw-bold text-decoration-none">Créer un compte admin</a>
        </p>
